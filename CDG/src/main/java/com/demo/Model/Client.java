...
public class Client implements Serializable {
    ...
    public Client(String id, String idClientTitre, String idClientEspece, String devise, String intitule, String numeroCompte, String codeGestionnaireFond, String descriptionGestionnaireFond, String[] numeroCompteEspeces) {
        this.id = id;
