...
public class DownloadExcelController {
    ...
    public  ResponseEntity<Client> viewemp(@PathVariable(value = "id") String id, Model m) {
        ...
        headers.setAccept(Arrays.asList(new MediaType[] { MediaType.APPLICATION_JSON })); // Request to return JSON format headers.setContentType(MediaType.APPLICATION_JSON);
        ...
        ResponseEntity<Client> response = restTemplate.exchange(url +id, HttpMethod.GET, entity, Client.class);
